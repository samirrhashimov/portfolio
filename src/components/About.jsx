    ...
    return (
        <div>
            ...
            <div className='flex gap-4 pb-[25px] max-md:flex-col'>
                <div className='border border-card-border p-4 flex-1 rounded-xl bg-card transition-colors duration-200 hover:border-border-hover'>
                ...
                <div className='border border-card-border p-4 flex-1 text-text font-[Inter] rounded-xl bg-card transition-colors duration-200 hover:border-border-hover'>
            ...
            <div className='grid grid-cols-3 gap-[18px] pb-[20px] max-md:grid-cols-2'>
                    <a className='group block overflow-hidden border border-card-border bg-card rounded-xl no-underline text-inherit transition-colors duration-200 hover:border-border-hover' href='https://learn.microsoft.com/api/credentials/share/en-us/samirrhashimov/ACA552F1F434C6A8?sharingId=CF4D36DF8A903864' target='_blank' rel='noreferrer'>
                ...
                <a className='group block overflow-hidden border border-card-border bg-card rounded-xl no-underline text-inherit transition-colors duration-200 hover:border-border-hover' href={edugovazFrontBackend} target='_blank' rel='noreferrer'>
                ...
                <a className='group block overflow-hidden border border-card-border bg-card rounded-xl no-underline text-inherit transition-colors duration-200 hover:border-border-hover' href='https://www.freecodecamp.org/certification/samirrhashimov/responsive-web-design' target='_blank' rel='noreferrer'>
            ...
            <div className='grid grid-cols-2 gap-[14px] pb-[20px] max-md:grid-cols-1'>
                {technologyGroups.map(group => (
                    <div key={group.titleKey} className='border border-card-border bg-card rounded-xl p-[14px] transition-colors duration-200 hover:border-border-hover'>
                        ...
                        <div className='flex flex-wrap gap-[8px]'>
                            {group.skills.map(skill => {
                                ...
                                return (
                                    <span key={skill.name} className='inline-flex items-center gap-[6px] border border-card-border rounded-[7px] px-[9px] py-[6px] text-[0.78rem] font-[Inter] font-semibold text-text transition-colors duration-200 hover:border-border-hover'>
