...
const Projects = () => {
    ...
    return (
        <div>
            ...
            {/* New area */}
            <h1 className='projectTypeText'>{t('projects.landingPages')}</h1>
            <div className='projectGrid'>
                <a className='gridElement' href={`https://github.com/${GITHUB_USERNAME}/snap-landing-page`} target='_blank' rel='noopener noreferrer'>
                    <div className='imageContainer'>
                        <img className='gridElementImg'
                            src={snapImg}
                            alt="snap Project"
                    ...
                    <p className='gridElementHeader'><b>Snap </b> - SaaS Page</p>
                </a>
                <a className='gridElement' href={`https://github.com/${GITHUB_USERNAME}/auraHydra-landing-page`} target='_blank' rel='noopener noreferrer'>
                    <div className='imageContainer'>
                        <img className='gridElementImg'
                            src={auraHydraImg}
                    ...
                    <p className='gridElementHeader'><b>AuraHydra</b> - DTC Page</p>
                </a>
                <a className='gridElement' href={`https://github.com/${GITHUB_USERNAME}/blogr-landing-page`} target='_blank' rel='noopener noreferrer'>
                    <div className='imageContainer'>
                        <img className='gridElementImg'
                            src={blogrImg}
                            alt="Blogr Project"
                    ...
                    <p className='gridElementHeader'><b>Blogr</b> - SaaS Page</p>
                </a>
                <a className='gridElement' href={`https://github.com/${GITHUB_USERNAME}/bank-landing-page`} target='_blank' rel='noopener noreferrer'>
                    <div className='imageContainer'>
                        <img className='gridElementImg'
                            src={digitalBankImg}
                    ...
                    <p className='gridElementHeader'><b>DigitalBank</b> - SaaS Page</p>
                </a>
            </div>
            {/* New area end */}
