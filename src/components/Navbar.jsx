            ...
            <div className='max-w-[1104px] mx-auto py-3 px-5 xl:px-0 flex justify-between items-center border-b-[1.2px] border-border bg-transparent'>
                ...
                <div className='flex gap-3 items-center'>
                    ...
                    <div className='flex gap-2.5 items-center'>
                        <button className='bg-transparent border border-border text-text p-1.5 rounded-[5px] cursor-pointer flex items-center justify-center font-medium transition-all duration-200 h-[32px] hover:border-border-hover hover:bg-hover-surface text-[0.8rem] min-w-[38px] font-[Inter]' onClick={changeLanguage}>
                            {i18n.language === 'en' ? 'AZ' : 'EN'}
                        </button>
                        <button className='bg-transparent border border-border text-text p-1.5 rounded-[5px] cursor-pointer flex items-center justify-center font-medium transition-all duration-200 h-[32px] hover:border-border-hover hover:bg-hover-surface text-[1.2rem]' onClick={toggleTheme}>
